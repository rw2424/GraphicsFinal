...
BufferObject TangentBuffer;
BufferObject BitangentBuffer;
...
int main(void)
{
    ...
    program.bindVertexAttribArray("tangents", TangentBuffer);
    program.bindVertexAttribArray("bitangents", BitangentBuffer);
